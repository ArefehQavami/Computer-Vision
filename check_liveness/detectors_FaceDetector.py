...
class Detector:
    ...
    def alignment_procedure(self, img, left_eye, right_eye):
        ...
        a = commons_distance.findEuclideanDistance(np.array(left_eye), np.array(point_3rd))
        b = commons_distance.findEuclideanDistance(np.array(right_eye), np.array(point_3rd))
        c = commons_distance.findEuclideanDistance(np.array(right_eye), np.array(left_eye))
