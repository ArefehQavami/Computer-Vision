...
from detectors_RWrapper import DetectFace
...
class LivenessDetection():
    ...
    def __init__(self):
        ...
        self.checkpoint = torch.load('E:/Face Verification/senet-face/code/check_liveness/net.pth'
