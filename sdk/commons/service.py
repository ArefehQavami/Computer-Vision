...
from commons.enums import Models, Metrics, Detector
...
from base import NetCust
from commons import functions
from commons.functions import create_resp
from detectors.RWrapper import DetectFace as FaceDetector
...
class VerificationModel(Singleton):
    ...
    def verify(self, img1_path, img2_path='', model_name=Models.FNET512.value, distance_metric=Metrics.COSINE.value,
               model=None,
               enforce_detection=True, detector_backend=Detector.RFACE.value, align=True, prog_bar=True,
    ...
    def detectFace(img_path, target_size=(224, 224), detector_backend=Detector.RFACE.value, enforce_detection=True,
